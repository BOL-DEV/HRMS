    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-2xl rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-line-subtle dark:bg-panel">
        <div className="flex items-start justify-between gap-4 border-b border-gray-200 p-5 dark:border-line-subtle">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-slate-400">
              Manage FO bill items for hospitals using automatic revenue flows.
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 p-5">
          <div className="grid gap-4 md:grid-cols-2">
            <label className="block space-y-2">
              ...
              <select
                ...
                className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-brand-500 dark:border-line-subtle dark:bg-canvas-alt dark:text-slate-100"
                required
              >
            ...
            <label className="block space-y-2">
              ...
              <select
                ...
                className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-brand-500 disabled:cursor-not-allowed disabled:bg-gray-100 dark:border-line-subtle dark:bg-canvas-alt dark:text-slate-100 dark:disabled:bg-panel-strong"
          ...
          <div className="flex items-center justify-end gap-3 border-t border-gray-200 pt-5 dark:border-line-subtle">
            <button
              type="button"
              onClick={onClose}
...
export default FoBillItemFormModal;
