...
const AgentSidebar = () => {
  ...
  return (
    <div className="relative">
      ...
      >
        {isOpen ? (
          <IoMdClose className="fixed left-45 top-7 z-50 inline-flex items-center justify-center rounded-xl bg-white p-2 text-4xl text-gray-700 shadow md:hidden dark:bg-panel-strong dark:text-slate-100" />
        ) : (
          <RxHamburgerMenu className="fixed left-4 top-5 z-50 inline-flex items-center justify-center rounded-xl bg-white p-2 text-4xl text-gray-700 shadow md:hidden dark:bg-panel-strong dark:text-slate-100" />
        )}
      </button>
