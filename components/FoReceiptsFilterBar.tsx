    ...
    <>
          ...
          <button
            ...
            className={`rounded-full border px-4 py-2 text-sm font-semibold transition-colors ${
              activeTab === tab.key
                ...
                : "border-gray-200 bg-white text-gray-700 hover:bg-gray-50 dark:border-line-subtle dark:bg-panel dark:text-slate-200 dark:hover:bg-panel-strong"
            }`}
          >
            {tab.label}
          </button>
      ...
      <div className="flex flex-col items-stretch gap-4 xl:flex-row">
        <div className="flex-1">
          <div className="flex items-center gap-3 rounded-2xl border border-gray-200 bg-white px-4 py-3 shadow-[0_18px_45px_rgba(15,23,42,0.05)] dark:border-line-subtle dark:bg-panel">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <button
            onClick={onRefresh}
            className="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-5 py-3 text-sm font-semibold shadow-[0_18px_45px_rgba(15,23,42,0.05)] hover:bg-gray-50 dark:border-line-subtle dark:bg-panel dark:text-slate-200 dark:hover:bg-panel-strong"
          >
