          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <label className="space-y-2">
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-brand-500 dark:border-line-subtle dark:bg-canvas-alt dark:text-slate-100"
                required
              />
            </label>
          ...
          <label className="block space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-gray-200 px-3 py-2.5 pr-11 text-sm outline-none focus:ring-2 focus:ring-brand-500 dark:border-line-subtle dark:bg-canvas-alt dark:text-slate-100"
                required
              />
              <button
                type="button"
