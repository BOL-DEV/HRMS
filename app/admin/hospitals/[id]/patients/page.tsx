      ...
      <div className="max-w-md">
        <div className="relative">
          ...
          <input
            ...
            inputMode="numeric"
            className="w-full rounded-lg border border-line-subtle bg-canvas-alt pl-10 pr-4 py-2 text-sm outline-none focus:ring-2 focus:ring-brand-500 dark:text-slate-100"
          />
        </div>
